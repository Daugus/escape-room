...
class HangmanSeeder extends Seeder
{
    ...
    public function run()
    {
        $ahorcado1 = new HangmanSolution();
        $ahorcado1->microorganism = 'Bacillus cereus';

        $ahorcado2 = new HangmanSolution();
        $ahorcado2->microorganism = 'Shigella sonnei';

        $ahorcado3 = new HangmanSolution();
        $ahorcado3->microorganism = 'Penicillium spp';

        $ahorcado4 = new HangmanSolution();
        $ahorcado4->microorganism = 'Staphilococcus aureus';

        $ahorcado5 = new HangmanSolution();
        $ahorcado5->microorganism = 'Candida albicans';

        $ahorcado6 = new HangmanSolution();
        $ahorcado6->microorganism = 'Brucella abortus';

        $ahorcado7 = new HangmanSolution();
        $ahorcado7->microorganism = 'Escherichia coli';

        $ahorcado8 = new HangmanSolution();
        $ahorcado8->microorganism = 'Aspergillus niger';

        $ahorcado9 = new HangmanSolution();
        $ahorcado9->microorganism = 'Lactobacillus casei';

        $ahorcado10 = new HangmanSolution();
        $ahorcado10->microorganism = 'Streptococcus thermophilus';

        $ahorcado11 = new HangmanSolution();
