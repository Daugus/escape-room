...
class PasswordSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $password1->text = 'Andrés Manuel del Río Fernández (Madrid, 10 de noviembre de 1764 — Ciudad de México, 23 de marzo de 1849) fue un científico y naturalista español, nacionalizado mexicano, descubridor del elemento químico vanadio en el año 1801, al que él denominó eritronio.1​';
        ...
        $password16->discovery_year = 'Bacilluscereus';
        ...
        $password46->element = 'Gadolinio, Iterbio';
        $password46->discovery_year = '1880, 1878';
        ...
        $password50->element = 'Manganeso, Selenio';
        $password50->discovery_year = '1774, 1817';
        ...
        $password52->element = 'Cerio, Selenio, Silicio, Torio';
        $password52->discovery_year = '1803, 1817, 1824, 1828';
        ...
        $password58->element = 'Cromo, Berilio';
        $password58->discovery_year = '1797, 1798';
